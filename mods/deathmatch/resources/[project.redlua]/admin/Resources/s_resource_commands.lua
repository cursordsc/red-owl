			...
			if (theResource) then
				...
				if resourceName:lower() == "interior-system" then
					if (not getElementData(thePlayer, "resconfirmed") and not exports["integration"]:isPlayerScripter(thePlayer)) then
						outputChatBox("Are you sure you want to restart Interior-system? It will be causing massive lag. Re-type it if you are sure.", thePlayer)
						...
						outputChatBox("* Interior may disappear during the time, please get out of any interior you're currently in.. *", root, 255, 0, 0)
					end

				elseif resourceName:lower() == "vehicle" then
					if (not getElementData(thePlayer, "resconfirmed") and not exports["integration"]:isPlayerScripter(thePlayer)) then
						outputChatBox("Are you sure you want to restart vehicle? It will be causing massive lag. Re-type it if you are sure.", thePlayer)
						outputChatBox("MSG from Scripters: Please do not restart this unless you -know- you need to restart it.", thePlayer)
						setElementData(thePlayer, "resconfirmed", true)
						setTimer(function ()
								setElementData(thePlayer, "resconfirmed", false)
						...
						outputChatBox("* Your vehicle may disappear for a short moment, please standby.. *", root, 255, 0, 0)
					end
				...
				elseif resourceName:lower() == "items" then
					if (not getElementData(thePlayer, "resconfirmed") and not exports["integration"]:isPlayerScripter(thePlayer)) then
						outputChatBox("Are you sure you want to restart items? It will be causing massive lag. Re-type it if you are sure.", thePlayer)
						setElementData(thePlayer, "resconfirmed", true)
						setTimer(function ()
								setElementData(thePlayer, "resconfirmed", false)
							end, 10000, 1)
				...
				elseif resourceName:lower() == "shop-system" then
					if (not getElementData(thePlayer, "resconfirmed") and not exports["integration"]:isPlayerScripter(thePlayer)) then
						...
						delayTime = 10*1000
						outputChatBox("* Shop-system is restarting in "..(delayTime/1000).." seconds! *", root, 255, 0, 0)
				...
				elseif resourceName:lower() == "item-world" then
					if (not getElementData(thePlayer, "resconfirmed") and not exports["integration"]:isPlayerScripter(thePlayer)) then
						...
						delayTime = 10*1000
						outputChatBox("* Item-world is restarting in "..(delayTime/1000).." seconds! *", root, 255, 0, 0)
						outputChatBox("* There will be a short Network Trouble during the time, please standby.. *", root, 255, 0, 0)
					end
				end
				setTimer(function ()
