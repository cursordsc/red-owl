...
function openWeaponCreatorMain(commandName, category)
	if exports["integration"]:isPlayerEGO(localPlayer) then
		...
		wWeaponsMain = guiCreateWindow(wWeaponsMain_x,wWeaponsMain_y,560,230,"Admin Weapon Creator v2.0 - QUICK MODE",false)
			...
			lCredit1 = guiCreateLabel(10,28,300,18,"Admin Weapon Creator v2.0 by Maxime",false,wWeaponsMain)
			...
			lCredit2 = guiCreateLabel(240,28,300,18,"© OwlGaming",false,wWeaponsMain)
...
addCommandHandler("silahver", openWeaponCreatorMain, false, false)
