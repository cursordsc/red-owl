roboto = guiCreateFont( ":fonts/files/RobotoB.ttf", 13 )
robotoL = guiCreateFont( ":fonts/files/Roboto.ttf", 10 )
rcmenu = false
local rcWidth = 0
local rcHeight = 0
...
function addRow(title,header,nohover)
	...
	if header then
		...
		guiLabelSetVerticalAlign(row, "center")
		image = guiCreateStaticImage(10, rcHeight+11, 15, 15, ":account/files/logo.png", false, rcmenu)
