--[[
* ***********************************************************************************************************************
* Copyright (c) 2019 PA Community - All Rights Reserved
* All rights reserved. This program and the accompanying materials are private property belongs to PA Community
...
function getMode()
	local mode = getElementData(localPlayer, "firemode")
    outputChatBox("Senin Tarzın ".. mode ..".", 255, 0, 0)
end
