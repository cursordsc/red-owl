...
local sphere = createColSphere(-1596.2556152344, 711.57775878906, 26.075946807861, 10)
setElementDimension(sphere, 0)
...
function isInArrestColshape( thePlayer )
    if isElementWithinColShape( thePlayer, sphere ) and (getElementDimension( thePlayer ) == 1) then -- Don't forget to change this
      return true
  end
  return false
end
