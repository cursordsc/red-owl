...
addEventHandler("realism:startdrinking", getRootElement(),
	function(hand)
		...
		exports["anticheat"]:changeProtectedElementDataEx(source, "realism:drinking", true, false )
		exports["anticheat"]:changeProtectedElementDataEx(source, "realism:drinking:hand", hand, false )
...
function stopdrinking(thePlayer)
	...
	if (isElement(thePlayer)) then	
		...
		if (isdrinking) then
			...
			exports["anticheat"]:changeProtectedElementDataEx(thePlayer, "realism:drinking", false, false )
		end
	end
end
