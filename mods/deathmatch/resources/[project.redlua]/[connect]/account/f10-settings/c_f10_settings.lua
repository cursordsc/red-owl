...
function showSettingsWindow()
	...
	GUIEditor_Window.main = guiCreateWindow(x,y,w,h,"Oyun Ayarları",false)
	...
	GUIEditor_Tab.graphicSettings = guiCreateTab("Hesap Ayarları",GUIEditor_TabPanel.main)
	--GUIEditor_Tab.accSettings = guiCreateTab(" Settings",GUIEditor_TabPanel.main)
	GUIEditor_Tab.charSettings = guiCreateTab("Karakter Ayarları",GUIEditor_TabPanel.main)
	local lineH = 0.0515
	local posY = lineH
	
	GUIEditor_Label.graphicSettingsgeneral = guiCreateLabel(0.0222,0.0361,0.313,lineH,"Genel Yapılandırmalar:",true,GUIEditor_Tab.graphicSettings)
	guiSetFont(GUIEditor_Label.graphicSettingsgeneral,"default-bold-small")

	GUIEditor_Checkbox.graphic_motionblur = guiCreateCheckBox(0.036,0.1005,0.2992,lineH,"Hareket Dolgunluğu Aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_skyclouds = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Gökyüzü Bulutlarını Aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.streams = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Ses Akışını Aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_logs = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("RluaLogs") then
	...
	GUIEditor_Checkbox.cellphone_log = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Arama/SMS Aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("RluaLogs") and getResourceFromName("phone") then
	...
	GUIEditor_Checkbox.graphic_chatbub = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Yazı Kabarcıklarını Aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_typingicon = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Yazan Simgeleri Aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("chat") then
	...
	GUIEditor_Checkbox.graphic_nametags = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Oyuncu İsimlerini Aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("nametag") then
	...
	GUIEditor_Checkbox.graphic_shaderradar = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Radar Gölgelendirmesini Aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_shaderwater = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Su/Deniz gölgelendirmesini Aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_shaderveh = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Araç Gölgelendirmesini Aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_shaderveh_reflect = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Araç Gölgelendirmesini Yansıtmayı Aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.graphic_shader_darker_night = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Karanlık gölgelendirmesini Aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("shader_darker_night") then
	...
	GUIEditor_Checkbox.autopark = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Otomatik Araç /park'lamayı Aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.antifalling = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"İnterior'da anti düşüş korumasını Aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("interiors") then
	...
	local posX = lineW2
	posY = 0.1005
	GUIEditor_Checkbox.vehicle_hotkey = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Araç Kısayol Tuşlarını Aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("vehicle") then
	...
	posY = posY + lineH
	GUIEditor_Checkbox.vehicle_rims = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Araç Jant Modellerini Aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	...
	--[[posY = posY + lineH
	GUIEditor_Checkbox.text2speech_ic_chats = guiCreateCheckBox(0.0222+posX,posY,0.313,lineH,"Yerel IC konuşma chat'ini Aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	...
	posX = posX + lineW2
	GUIEditor_Label.graphicSettings_desc = guiCreateLabel(0.0222+posX,0.0361,0.313,lineH,"Kaplama Yapılandırmalarını Aktifleştir:",true,GUIEditor_Tab.graphicSettings)
	guiSetFont(GUIEditor_Label.graphicSettings_desc,"default-bold-small")
	
	GUIEditor_Checkbox.enableOverlayDescription = guiCreateCheckBox(0.036+posX,0.1005,0.2992,lineH,"Tüm Geçiş Tariflerini Aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	...
	GUIEditor_Checkbox.enableOverlayDescriptionVeh = guiCreateCheckBox(0.036+posX,0.1005+lineH,0.2992,lineH,"Araç tanıtmını Aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("description") then
	...
	cFontVeh = guiCreateComboBox ( 0.036+posX+0.055,0.1005+lineH*2,0.2,lineH,  getElementData(localPlayer, "cFontVeh") or "Varsayılan", true, GUIEditor_Tab.graphicSettings )
	local count1 = 0 
	...
	GUIEditor_Checkbox.enableOverlayDescriptionPro = guiCreateCheckBox(0.036+posX,0.1005+lineH*3,0.2992,lineH,"İnterior Tanıtımı Aktifleştir",false,true,GUIEditor_Tab.graphicSettings)
	if getResourceFromName("description") then
	...
	cFontPro = guiCreateComboBox ( 0.036+posX+0.055,0.1005+lineH*4,0.2,lineH,  getElementData(localPlayer, "cFontPro") or "Varsayılan", true, GUIEditor_Tab.graphicSettings )
	local count1 = 0 
	for key, font in pairs(fonts) do
	...
	GUIEditor_Label.charSettingsgeneral = guiCreateLabel(0.0222,0.0361,0.313,lineH,"Karakter Yapılandırmaları:",true,GUIEditor_Tab.charSettings)
	guiSetFont(GUIEditor_Label.charSettingsgeneral,"default-bold-small")

	GUIEditor_Checkbox.phone_anim = guiCreateCheckBox(0.036,0.1005,0.2992,lineH,"Telefon Animasyonunu Aktifleştir",false,true,GUIEditor_Tab.charSettings)
	...
	GUIEditor_Checkbox.talk_anim = guiCreateCheckBox(0.036,0.1005+posY,0.2992,lineH,"Konuşma Animasyonunu Aktifleştir",false,true,GUIEditor_Tab.charSettings)
...
function applyGameSettings(name, value)
	if name and value then
		if name == "duty_admin" or name == "duty_supporter" or name == "wrn:style" or name == "chatType" then
