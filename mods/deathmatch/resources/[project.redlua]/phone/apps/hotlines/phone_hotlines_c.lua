...
function drawPhoneHotlines(xoffset, yoffset)
	...
	for lineNumber, lineName in pairs(hotlines) do 
	    ...
	    guiCreateStaticImage(163+xoffset, 15+yoffset, 48, 14, "components/images/call.png", false, wHotlines)
	    ...
	    guiCreateStaticImage(179+xoffset, 16+yoffset, 17, 12, "components/images/sms.png", false, wHotlines)
		...
		guiSetAlpha(guiCreateStaticImage(10+xoffset, 50+yoffset, 200, 1, ":admin\img\whitedot.png", false, wHotlines), 0.1)
	    yoffset = yoffset + 40 
	    count = count + 1
	end
	if count > 0 then
