function loadFonts()
    fonts = {
        ...
        [3] = DxFont(":fonts/files/RobotoL.ttf", 12),
        [4] = DxFont(":fonts/files/RobotoL.ttf", 10),
        [5] = DxFont(":fonts/files/RobotoL.ttf", 9),
        [6] = DxFont(":fonts/files/RobotoL.ttf", 6),
        [7] = GuiFont(":fonts/files/RobotoL.ttf", 10),
        [8] = DxFont(":fonts/files/RobotoL.ttf", 8.4),
        [9] = DxFont(":fonts/files/FontAwesome5.ttf", 10),
        [10] = DxFont(":fonts/files/FontAwesome.ttf", 7),
        [11] = DxFont(":fonts/files/Roboto-Regular.ttf", 10),
        [12] = DxFont(":fonts/files/RobotoB.ttf", 10),
        [13] = DxFont(":fonts/files/FontAwesome.ttf", 10),
