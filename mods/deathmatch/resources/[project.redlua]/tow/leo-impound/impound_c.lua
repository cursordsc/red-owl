...
--SERVICE PED
local pdImpounder = createPed( 281, 0, 0, 0 )
setPedRotation( pdImpounder, 180 )
...
local hpImpounder = createPed( 288, 0, 0, 0 )
...
local pdReleasePed = createPed(280, 0, 0, 0 )
setPedRotation( pdReleasePed, 270 )
setElementDimension( pdReleasePed, 0)
setElementInterior( pdReleasePed , 0 )
...
local hpReleasePed = createPed( 288, 0, 0, 0 )
setPedRotation( hpReleasePed, 1.2826843261719 )
setElementDimension( hpReleasePed, 0)
setElementInterior( hpReleasePed , 0 )
