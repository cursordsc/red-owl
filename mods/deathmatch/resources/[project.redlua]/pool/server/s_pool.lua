...
local idelementdata =
{
	player = "playerid", --Player ID on scoreboard, not character id in database - MAXIME
	interior = "dbid",
	elevator = "dbid",
	vehicle = "dbid",
	team = "id",
...
--[[ --Disabled because it will be detected as infinite running script and will be aborted by MTA anyway. Below is an alternative/better solution / Maxime
...
--[[addEventHandler("onResourceStop", resourceRoot, function () --Maxime
	...
	exports["data"]:save(indexedPools, "indexedPools") --Ben kapadım bir şey bozulduysa budur aç eventden itibaren
end)]]
