...
function colorPicker.create(id, start, title)
  ...
  cp.gui.window = guiCreateWindow(sw-cp.gui.width-5, (sh-cp.gui.height)/2, cp.gui.width, cp.gui.height, tostring(title or "COLORPICKER"), false)
  cp.gui.svmap = guiCreateStaticImage(16, 32, 256, 256, "assets/colorpicker/blank.png", false, cp.gui.window)
  cp.gui.hbar = guiCreateStaticImage(288, 32, 32, 256, "assets/colorpicker/blank.png", false, cp.gui.window)
  cp.gui.blank = guiCreateStaticImage(336, 32, 64, 64, "assets/colorpicker/blank.png", false, cp.gui.window)
...
function colorPicker:render()
  ...
  dxDrawImage(x+16, y+32, 256, 256, "assets/colorpicker/sv.png", 0, 0, 0, self.color.white, self.gui.focus)
  dxDrawImage(x+288, y+32, 32, 256, "assets/colorpicker/h.png", 0, 0, 0, self.color.white, self.gui.focus)
  dxDrawImageSection(x+8+math.floor(256*self.color.s), y+24+(256-math.floor(256*self.color.v)), 16, 16, 0, 0, 16, 16, "assets/colorpicker/cursor.png", 0, 0, 0, self.color.white, self.gui.focus)
  dxDrawImageSection(x+280, y+24+(256-math.floor(256*self.color.h)), 48, 16, 16, 0, 48, 16, "assets/colorpicker/cursor.png", 0, 0, 0, self.color.huecurrent, self.gui.focus)
