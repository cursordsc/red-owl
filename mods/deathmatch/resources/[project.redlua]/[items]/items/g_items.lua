g_items = {
	...
	[78] = { "RED:LUA Pilot Certificate", "An official permission to fly planes and helicopters.", 10, 1581, 270, 270, 0, 0, weight = 0.3 },
	...
	[112] = { "RED:LUA Highway Patrol badge", "#v", 10, 1581, 270, 270, 0, 0, weight = 0.3 }, -- 142
	...
	[128] = { "Modifiyeci", "#v", 10, 1581, 270, 270, 0, 0, weight = 0.3 }, --128 -- cursor | ADD TTR FACTION BAGDE ITEM | 24.1.14
	...
	[156] = { "Superior Court of RED:LUA ID", "#v", 10, 1581, 270, 270, 0, 0, weight = 0.1 },
	...
	[160] = { "El Çantası", "Bir adet el çantası.", 6, 1210, 90, 0, 0, 0.1, weight = 0.4}, -- cursor
	...
	[162] = { "Çelik Yelek", "Mermi geçirmeyen bir çelik yelek.", 6, 3916, 90, 0, 0, 0.1, weight = 4}, -- cursor
	[163] = { "Valiz", "Geniş bir valiz.", 6, 3915, 90, 0, 0, 0.2, weight = 0.4}, -- cursor
	[164] = { "Tıbbı Çanta", "Tıbbi araçlar içeren çanta.", 6, 3915, 0, 0, 0, 0.2, weight = 1, texture = {{":artifacts/textures/medicbag.png", "hoodyabase5"}} }, -- cursor
	[165] = { "DVD", "A video disc.", 4, 2894, 0, 0, 0, -0.01, weight = 0.1 }, -- cursor
	[166] = { "ClubTec VS1000", "Video System.", 4, 3388, 0, 0, 90, -0.01, weight = 5, scale = 0.6,  newPickupMethod = true }, -- cursor
	[167] = { "Framed Picture (Golden Frame)", "Put your picture in and hang it on your wall.", 4, 2287, 0, 0, 0, 0, weight = 1, doubleSided = true, newPickupMethod = true }, -- cursor
	[168] = { "Orange Bandana", "A orange rag.", 6, 2386, 0, 0, 0, 0.1, weight = 0.2 },
	[169] = { "Keyless Digital Door Lock", "This high-ended security system is much more secure than a traditional keyed lock because they can't be picked or bumped.", 6, 2922, 0, 0, 180, 0.2, weight = 0.5 }, -- cursor
	[170] = { "Keycard", "A swipe card for #v", 2, 1581, 270, 270, 0, 0, weight = 0.1 }, -- cursor
	...
	[174] = { "FAA Electronical Map Book", "Electronic device displaying information and maps around all RED:LUA.", 4, 1271, 0, 0, 0, -0.01, weight = 0.01 }, -- Anumaz
	[175] = { "Poster", "An advertising poster.", 4, 2717, 0, 0, 0, 0.7, weight = 0.01, hideItemValue = true }, -- cursor
    ...
    [179] = { "Car Motive", "A motive to decorate your car with.", 4, 2894, 0, 0, 0, -0.01, weight = 0.01 }, -- cursor
    [180] = { "SAPT ID", "#v", 10, 1581, 270, 270, 0, 0, weight = 0.3}, -- cursor
	...
	[210] = { "Coca-Cola Christmas", "A bottle of coke, christmas edition.", 1, 2880, 180, 0, 0, 0, weight = 0.2}, -- cursor
	[211] = { "A Christmas Lottery Ticket", "From the Coca-Cola Santa.", 10, 1581, 270, 270, 0, 0, weight = 0.1}, -- cursor
	[212] = { "Snow Tires", "Stick to the ground like velcro!", 4, 1098, 0, 0, 0, 0, weight = 1}, -- cursor
	[213] = { "Pinnekjott", "cursor's christmas favourite.", 1, 2215, 205, 205, 0, 0.06, weight = 0.1, preventSpawn = true}, -- cursor
	[214] = { "Generic Drug", "#v", 3, 1576, 0, 0, 0, 0.07, weight = 0.1}, -- Chaos
	[215] = { "Akustik Gitar", "Takamine marka akustik gitar.", 4, 1901, 0, 180, 360, 0.06, weight = 0.1}, -- cursor
	[227] = { "Nargile", "Seri köz getir kardeşim.", 1, 1902, 0, 0, 0, 0.3, weight = 2, hideItemValue = true }, -- cursor
	[228] = { "Fotoğraf", "Bir adet fotoğraf.", 1, 1271, 0, 0, 0, 0, weight = 0.1, hideItemValue = true }, -- cursor
	[229] = { "Tuborg Bira", "Adam gibi bira - Tuborg.", 1, 1520, 0, 0, 0, 0, weight = 1, }, -- cursor
	[230] = { "Yeni Rakı", "Yeni rakı.", 1, 1520, 0, 0, 0, 0, weight = 1, }, -- cursor
	...
	[248] = { "Bilardo Masası", "Tek kullanımlıktır, sadece interior içerisine kurulabilir.", 1, 1581, 0, 0, 0, 0, weight = 0.5 }, -- cursor
	[249] = { "Araç Ruhsatı", "Bir adet araç tescil belgesi.", 1, 1581, 0, 0, 0, 0, weight = 0.5 }, -- cursor
	
	[250] = { "Balık Yemi", "#v adet balık yemi.", 1, 1271, 0, 0, 0, 0, weight = 1 }, -- cursor
	
	[251] = { "Simit", "Bir adet gevrek simit.", 1, 1925, 0, 0, 0, 0, weight = 0.25 }, -- cursor
	[252] = { "Açma", "Bir adet yumuşak açma.", 1, 1925, 0, 0, 0, 0, weight = 0.25 }, -- cursor
	...
	[272] = { "Maymuncuk", "Kilit Kırmaya Yarayan Bir Çeşit Alet.", 6, 3915, 90, 0, 0, 0.2, weight = 0.4}, -- cursor
	[273] = { "Mataryal", "Bir Çeşit Materyal.", 6, 3915, 90, 0, 0, 0.2, weight = 0.4}, -- cursor
	...
	[515] = { "Tamirci Kartı", "Tamirci Kartı", 10, 1581, 270, 270, 0, 0, weight = 0.1 }, -- cursor babe
	[555] = { "İstiridye", "/istiridyeac yazarak istiridyeyi açabilirsin.", 4, 2386, 0, 0, 0, 0.285, weight = 2 }, --cursor
	[556] = { "Kırmızı İnci", "Muazzam parlayan bir kırmızı inci.", 4, 2386, 0, 0, 0, 0.285, weight = 2 }, --cursor
	[557] = { "Mavi İnci", "Muazzam parlayan bir mavi inci.", 4, 2386, 0, 0, 0, 0.285, weight = 2 }, --cursor
	[558] = { "Yeşil İnci", "Muazzam parlayan bir yeşil inci.", 4, 2386, 0, 0, 0, 0.285, weight = 2 }, --cursor
	[559] = { "Beyaz İnci", "Muazzam parlayan bir beyaz inci.", 4, 2386, 0, 0, 0, 0.285, weight = 2 }, --cursor
	[560] = { "Çeyrek Altın", "Döviz bürosunda bozdurabileceğiniz Çeyrek Altın.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --cursor
    [561] = { "Cumhuriyet Altın", "Döviz bürosunda bozdurabileceğiniz Cumhuriyet Altın.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --cursor
    [562] = { "Altın Bilezik", "Döviz bürosunda bozdurabileceğiniz Altın Bilezik.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --cursor
    [563] = { "Kazı Kazan", "Kazı ve Kazan!", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --cursor
    [568] = { "İşlenmemiş Taş", "Fabrikada işleyebileceğiniz bir taş parçası.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --cursor
    [569] = { "İşlenmemiş Kömür", "Fabrikada işleyebileceğiniz bir kömür parçası.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --cursor
    [570] = { "İşlenmemiş Bakır", "Fabrikada işleyebileceğiniz bir bakır parçası.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --cursor
    [571] = { "İşlenmemiş Demir", "Fabrikada işleyebileceğiniz bir demir parçası.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --cursor
    [572] = { "İşlenmemiş Altın", "Fabrikada işleyebileceğiniz bir altın parçası.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --cursor
    [573] = { "İşlenmiş Taş", "Borsa bürosunda bozdurabileceğiniz işlenmiş bir taş.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --cursor
    [574] = { "İşlenmiş Kömür", "Borsa bürosunda bozdurabileceğiniz işlenmiş bir kömür.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --cursor
    [575] = { "İşlenmiş Bakır", "Borsa bürosunda bozdurabileceğiniz işlenmiş bir bakır.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --cursor
    [576] = { "İşlenmiş Demir", "Borsa bürosunda bozdurabileceğiniz işlenmiş bir demir.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --cursor
    [577] = { "İşlenmiş Altın", "Borsa bürosunda bozdurabileceğiniz işlenmiş bir altın.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --cursor	
    [578] = { "Kazma", "Kazı yaparken kullanabileceğiniz bir eşya.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --cursor	
	[579] = { "Barbekü", "( /barbekukur - /barbekukaldir - /fastfood ).", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --cursor
	...
	[582] = { "Silah Kasası", "Üzerine tıklayarak gelen şansı değerlendirebilirsin.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --cursor
	[583] = { "Premium Silah Kasası", "Üzerine tıklayarak gelen şansı değerlendirebilirsin.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --cursor
	[584] = { "Levye", "Kutuları açmanı sağlayacak bir levye.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --cursor
	[585] = { "Kokain Tohumu", "Kokain ekmenizi sağlayacak bir tohum.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --cursor
	[586] = { "Marijuana Tohumu", "Marijuana ekmenizi sağlayacak bir tohum.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --cursor
	[587] = { "Eroin Tohumu", "Eroin ekmenizi sağlayacak bir tohum.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --cursor
	[588] = { "Bant", "Ağıza yapıştırılabilecek bir bant.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --cursor
	[589] = { "Tütün", "Sigara sarmanızda işinize yarıyacak bir madde..", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --cursor
	[590] = { "Kaçak Sigara Paketi", "Gizli bir firmaya satabileceğiniz kaçak bir sigara paketi.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --cursor
	[591] = { "Pizza", "Mikrodalgadan yeni çıkmış, leziz bir pizza.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --cursor
	[592] = { "Piliç", "Mikrodalgadan yeni çıkmış, leziz bir piliç.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --cursor
	[593] = { "Omlet", "Mikrodalgadan yeni çıkmış, leziz bir omlet.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --cursor
	[594] = { "Metanol", "Meth üretmeniz için gerekli bir kimyasal madde olan 'Metanol'.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --cursor
	[595] = { "Red Phosphorus", "Meth üretmeniz için gerekli bir kimyasal madde olan 'Red Phosphorus'.", 6, 1271, 0, 0, 0, 0.285, weight = 0.5 },
	[596] = { "Metilamin", "Meth üretmeniz için gerekli bir kimyasal madde olan 'Metilamin'.", 6, 1271, 0, 0, 0, 0.285, weight = 0.5 },

	[597] = { "Odun", "Ateş Yakmanız için gerekli bir ürün'.", 4, 2386, 0, 0, 0, 0.285, weight = 0.1 }, --cursor
	[598] = { "Kömür","Ateş Yakmanız için gerekli bir ürün'.", 6, 1271, 0, 0, 0, 0.285, weight = 0.5 },
	[599] = { "Çakmak","Ateş Yakmanız için gerekli bir ürün'.", 6, 1271, 0, 0, 0, 0.285, weight = 0.5 },
