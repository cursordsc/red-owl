...
function elKoy(plr, commandName, targetName, weaponSerial)
	if getElementData(plr, "faction") == 1 or getElementData(plr, "faction") == 78 then
		if not (targetName) or (not weaponSerial) then
			return outputChatBox("|| RED:LUA || /" .. commandName .. " [Oyuncu İsmi/ID] [Silah Seriali]", plr, 255, 194, 14)
		end
		local targetPlayer, targetPlayerName = exports.global:findPlayerByPartialNick(plr, targetName)
		if not targetPlayer then
			return outputChatBox("[!] #ffffffKişi bulunamadı.", plr, 255, 0, 0, true)
		end
		local itemSlot = exports['items']:getItems(targetPlayer)
		for i, v in ipairs(itemSlot) do
			if exports.global:explode(":", v[2])[2] and (exports.global:explode(":", v[2])[2] == weaponSerial) then
				...
				local eskiHak = (#tostring(exports.global:explode(":", v[2])[5])>0 and exports.global:explode(":", v[2])[5]) or 3
				...
				exports.global:takeItem(targetPlayer, 115, v[2])
				if (yeniHak) > 0 then
					eren = exports.global:explode(":",v[2])[1]..":"..exports.global:explode(":",v[2])[2]..":"..exports.global:explode(":",v[2])[3].."::"..yeniHak
					exports.global:giveItem(targetPlayer, 115, eren)
					local suffix = "kişi"
					outputChatBox("[!] #ffffff"..targetPlayerName.." adlı kişinin, "..exports.global:explode(":", v[2])[3].." silahına el koydunuz. Kalan silah hakkı: "..(yeniHak).."", plr, 0, 55, 255, true)
					outputChatBox("[!] #ffffff"..getPlayerName(plr).." adlı kişi "..exports.global:explode(":", v[2])[3].." silahınıza el koydu. Kalan silah hakkınız: "..(yeniHak).."", targetPlayer, 0, 55, 255, true)
					return
				else
					outputChatBox("[!] #ffffff"..targetPlayerName.." adlı kişinin, "..exports.global:explode(":", v[2])[3].." silahına el koydunuz. Silah silindi.", plr, 0, 55, 255, true)		
					outputChatBox("[!] #ffffff"..getPlayerName(plr).." adlı kişi"..exports.global:explode(":", v[2])[3].." silahınıza el koydu. GG EASY BOY!", targetPlayer, 0, 55, 255, true)		
					return
				end
			end
		end
