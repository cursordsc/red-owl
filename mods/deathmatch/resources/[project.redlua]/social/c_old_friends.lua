...
function askAcceptFriend()
	...
	wConfirmFriendRequest = guiCreateWindow(sx/2 - 150,sy/2 - 50,300,100,"Arkadaşlık Teklifi Geldi", false)
	local lQuestion = guiCreateLabel(0.05,0.25,0.9,0.3,getPlayerName(source):gsub("_", " ") .. " adlı kişi sizi arkadaş olarak eklemek istiyor. Kabul ediyor musunuz?",true,wConfirmFriendRequest)
	guiLabelSetHorizontalAlign (lQuestion,"center",true)
	bButtonYes = guiCreateButton(0.1,0.65,0.37,0.23,"Evet",true,wConfirmFriendRequest)
	bButtonNo = guiCreateButton(0.53,0.65,0.37,0.23,"Hayır",true,wConfirmFriendRequest)
