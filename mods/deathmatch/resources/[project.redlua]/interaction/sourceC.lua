...
local robotobold = exports.assets:getFont("in-bold", 12)
local robotobold2 = exports.assets:getFont("fontAwesome", 10)
...
Interaction.Panel = function(interactions,durum)
    if interactionActive then
        ...
        if getElementType(selectedElement) == "vehicle" then
            ...
            panelW = textW + respc(30)
            rowW = textW + respc(30)
        end

        dxDrawRoundedRectangle(panelX, panelY - 100, panelW, panelH + (rowH * adjustH), 10,tocolor(10, 10, 10, 235))
        ...
        if getElementType(selectedElement) == "vehicle" then
            ...
            dxDrawText("oyun kontrolleri", panelX + 5, panelY - 100 + respc(8), panelW + panelX, panelH + panelY - 100, tocolor(255, 255, 255, 255), 1, robotobold, "center", "top")
        elseif getElementType(selectedElement)=="ped"then
            dxDrawText("ped kontrolleri", panelX, panelY - 100 + respc(10), panelW + panelX, panelH + panelY - 100, tocolor(255, 255, 255, 255), 1, robotobold, "center", "top")
        ...
        elseif getElementType(selectedElement) == "vehicle" then
            --dxDrawText("arac kontrolleri",  panelX+ 5, panelY - 122 + respc(8) + dxGetFontHeight(1, fonts.Roboto14), panelW + panelX, panelH + panelY - 100, tocolor(255, 255, 255, 255), 1, robotobold, "center", "top")
		elseif getElementType(selectedElement) == "player" then
