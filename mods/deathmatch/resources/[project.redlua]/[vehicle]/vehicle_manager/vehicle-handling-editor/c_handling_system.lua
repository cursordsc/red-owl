...
function createHandlingWindow(mode)
	...
	suspensionBias = guiGridListAddRow(handlingList)
		guiGridListSetItemText(handlingList, suspensionBias, nameColumn, "Süspansiyon Sapması", false, false)
	...
	suspensionDamping = guiGridListAddRow(handlingList)
		guiGridListSetItemText(handlingList, suspensionDamping, nameColumn, "Süspansiyon Sönümlemesi", false, false)
	...
	massWeight = guiGridListAddRow(handlingList)
		guiGridListSetItemText(handlingList, massWeight, nameColumn, "Araç Kilosu (Kg)", false, false)
	...
	massX = guiGridListAddRow(handlingList)
		guiGridListSetItemText(handlingList, massX, nameColumn, "Kütle Merkezi X", false, false)
	...
	massY = guiGridListAddRow(handlingList)
		guiGridListSetItemText(handlingList, massY, nameColumn, "Kütle Merkezi Y", false, false)
	...
	massZ = guiGridListAddRow(handlingList)
		guiGridListSetItemText(handlingList, massZ, nameColumn, "Kütle Merkezi Z", false, false)
	...
	brakeBias = guiGridListAddRow(handlingList)
		guiGridListSetItemText(handlingList, brakeBias, nameColumn, "Fren Sapması", false, false)
	...
	if mode == 0 then -- All Instances
		bReset = guiCreateButton(0.05, 0.925, 0.45, 0.05, "Normali Yükle", true, wHandling)
		...
		bSave = guiCreateButton(0.5, 0.925, 0.45, 0.05, "Kaydet", true, wHandling)
