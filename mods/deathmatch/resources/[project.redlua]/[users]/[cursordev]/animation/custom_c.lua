local anims_list = {
	...
	['custom_1'] = {'custom/custom_1.ifp', true, price = 0, name = "Sheriff Animasyon Fiziği", engine = 1, disabled = 0}, -- Gang 1
	...
	['custom_6'] = {'custom/custom_6.ifp', true, price = 0, name = "RED:LUA Animasyon Fiziği I", engine = 1, disabled = 0}, -- Project Awesome
	['custom_7'] = {'custom/custom_7.ifp', true, price = 0, name = "RED:LUA Kadın Yürüme Fiziği", engine = 1, disabled = 0}, -- Female Remaked
	['custom_8'] = {'custom/custom_8.ifp', true, price = 0, name = "Çete Animasyon Fiziği II", engine = 1, disabled = 0}, -- Gang 4
	['custom_9'] = {'custom/custom_9.ifp', true, price = 0, name = "RED:LUA Animasyon Fiziği II", engine = 1, disabled = 0}, -- New Animations for GTA:SA
...
addCommandHandler("rapping",
	function(cmd, id)
		if not id then outputChatBox("[!]#ffffff Komut Kullanımı: /"..cmd.." (1-8)", 255, 0, 0, true) return end
		local index = "rapping"
		local customtable = getElementData(localPlayer, "custom_animations") or {}
		if customtable[index] or (tonumber(anims_list[index].price) == 0) then
...
addCommandHandler("animpanel",
	function()
		...
		if getElementData(localPlayer, "loggedin") == 1 then
			...
			window = guiCreateWindow(0, 0, 549, 335, "RED:LUA Roleplay - Özel Animasyon Arayüzü", false)
