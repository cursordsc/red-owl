...
function driveBy1(thePlayer)
	...
	if (logged==1) then
		exports.global:applyAnimation( thePlayer, "DRIVEBYS", "Gang_DrivebyRHS_Bwd", -1, true, false, false)
	end
end
...
function idleAnimation(thePlayer)
	...
	if (logged==1) then
		exports.global:applyAnimation(thePlayer, "DEALER", "DEALER_IDLE_01", -1, true, false, true)
	end
end
...
function idle1Animation(thePlayer)
	...
	if (logged==1) then
		exports.global:applyAnimation(thePlayer, "DEALER", "DEALER_IDLE", -1, true, false, false)
	end
end
...
function gsign1Animation(thePlayer)
	...
	if (logged==1) then
		exports.global:applyAnimation(thePlayer, "GHANDS", "gsign1", -1, true, false, false)
	end
end
...
function gsign2Animation(thePlayer)
	...
	if (logged==1) then
		exports.global:applyAnimation(thePlayer, "GHANDS", "gsign1LH", -1, true, false, false)
	end
end
...
function gsign3Animation(thePlayer)
	...
	if (logged==1) then
		exports.global:applyAnimation(thePlayer, "GHANDS", "gsign2LH", -1, true, false, false)
	end
end
...
function sitAnimation(thePlayer, cmd, arg)
	...
	if (logged==1) then
		if isPedInVehicle( thePlayer ) then
			...
			elseif arg == 8 then
			--	exports.global:applyAnimation( thePlayer, "SWAT", "JMP_Wall1m_180", 1, false, false, false)
...
function polisoturAnimation(thePlayer)
	...
	if (logged==1) then
		exports.global:applyAnimation( thePlayer, "CAMERA", "camcrch_idleloop", -1, true, false, false)
	end
end
...
function bompAnimation(thePlayer, cmd, arg)
	...
	if (logged==1) then
		exports.global:applyAnimation( thePlayer, "BOMBER", "BOM_Plant", -1, false, false, false)
	end
end
...
function kartopuAnimation(thePlayer, cmd, arg)
	...
	if (logged==1) then
		exports.global:applyAnimation( thePlayer, "GRENADE", "WEAPON_throw", -1, false, false, false)
	end
end
...
function kollariniac(thePlayer, cmd, arg)
	...
	if (logged==1) then
		exports.global:applyAnimation( thePlayer, "BSKTBALL", "BBALL_def_loop", -1, false, false, false)
	end
end
...
function yaslanmaAnimasyonlari(thePlayer, cmd, arg)
	...
	source = thePlayer
		if arg == 2 then
			exports.global:applyAnimation( thePlayer, "BAR", "BARman_idle", -1, true, false, false)
		elseif arg == 3 then
			exports.global:applyAnimation( thePlayer, "Attractors", "Stepsit_loop", -1, true, false, false)
		else
